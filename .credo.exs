...
%{
  ...
  configs: [
    %{
      ...
      #
      requires: ["lib_dev/glorbo/credo/check/raw_filesystem_write_in_live.ex"],
      #
      ...
      checks: %{
        enabled: [
          ...
          ## Readability Checks
          #
          # Phase 1 disables: subjective and forces churn without real value.
          {Credo.Check.Readability.AliasOrder, false},
          {Credo.Check.Readability.FunctionNames, []},
          {Credo.Check.Readability.LargeNumbers, []},
          {Credo.Check.Readability.MaxLineLength, [priority: :low, max_length: 120]},
          {Credo.Check.Readability.ModuleAttributeNames, []},
          # Phase 1 disables: stub modules use @moduledoc false legitimately.
          ...
          # GEP-12 / T-03-15: block atom creation from user input. The stock
          # Credo rule covers String.to_atom, List.to_atom, :erlang.{binary,list}_to_atom,
          # Module.concat/{1,2}, and Jason.decode(..., keys: :atoms).
        ...
        disabled: [
          ...
          # UnsafeToAtom moved to :enabled list — see GEP-12.
