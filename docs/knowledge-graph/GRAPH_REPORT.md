...
## Corpus Check
- 227 files · ~171,645 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2765 nodes · 5217 edges · 103 communities detected
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 1114 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (132): Glorbo.CLI.Scaffold.Agent, detect_missing_skills(), do_run(), do_scaffold(), glorbo_home(), help_text(), maybe_write_heartbeat(), maybe_write_soul() (+124 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (74): GlorboWeb.MCP.Tools.ApproveTask, audit_opt(), do_call(), mcp_actor(), GlorboWeb.MCP.Tools.CaptureBrainDump, do_call(), glorbo_home(), GlorboWeb.MCP.Tools.DenyTask (+66 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (95): mark_director_approval(), Glorbo.Company.AgentBoot, boot_one(), do_boot(), maybe_register_heartbeat(), run(), start_and_register(), Glorbo.Company.AgentSupervisor (+87 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (85): backfill_stdout(), mount_valid(), provider_options(), provider_options(), GlorboWeb.CoreComponents, icon(), Glorbo.CLI.Dispatcher, add_transform_substitutions() (+77 more)

### Community 4 - "Community 4"
Cohesion: 0.04
Nodes (90): GlorboWeb.CompanyLive, activity_hint(), agent_pill_label(), agent_pill_status(), agent_runtime_status(), agent_used_usd(), append_if_nonempty(), audit_last_wakes() (+82 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (101): Glorbo.Security.ACLMapper, check_action(), fs_fun(), rm(), Glorbo.Company.Router, append_line!(), append_task_comment(), atomic_write() (+93 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (94): pasta_availability(), Glorbo.CLI.Lifecycle.Daemon, do_spawn(), executable?(), local_glorbo_binary(), self_binary(), validate_binary(), Glorbo.Agent.Dispatch (+86 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (80): Glorbo.FileSpec.AgentMd, canonical_key_order(), docs(), frontmatter_schema(), kind(), Glorbo.DB.Bootstrap, child_spec(), do_migrate() (+72 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (81): GlorboWeb.AgentLive, action_class(), agent_dir(), agent_name(), agent_pill_label(), agent_pill_status(), audit_for_this_agent?(), build_sandbox_preview() (+73 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (73): Glorbo.Inbox.Archive, list(), path(), write(), Glorbo.BrainDump, apply_section_removal(), build_entry(), convert_to_task() (+65 more)

### Community 10 - "Community 10"
Cohesion: 0.04
Nodes (61): Glorbo.CLI.Lifecycle.Down, do_run(), glorbo_home(), help_text(), run(), stop_running(), wait_for_exit(), GlorboWeb.ErrorHTML (+53 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (60): Glorbo.Filesystem.FrontmatterWriter, atomic_write(), maybe_filter_blank(), rewrite(), rewrite_line(), yaml_scalar(), Mix.Tasks.Glorbo.ReleaseFormula, fetch_sha256sums() (+52 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (68): decode(), Glorbo.CLI.Parsers.ClaudeJsonl, accumulate(), count_tool_calls(), decode_line(), Glorbo.CLI.Parsers.CodexJsonl, decode_line(), read_audit_lines() (+60 more)

### Community 13 - "Community 13"
Cohesion: 0.05
Nodes (48): GlorboWeb.Actions, extract_frontmatter(), hire_argv(), hire_task?(), lookup_requesting_agent(), maybe_put_assigned_to(), maybe_rotate_channel(), maybe_scaffold_hired_agent() (+40 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (40): Glorbo.Application, maybe_write_pidfile(), release_argv(), run_cli_and_halt(), running_standalone?(), start(), start_supervision_tree(), start_supervision_tree_for_serve() (+32 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (52): mount(), GlorboWeb.KanbanLive, apply_goal_filter(), apply_project_filter(), apply_search_filter(), apply_who_filter(), build_body(), build_kanban_title() (+44 more)
...
Cohesion: 0.07
Nodes (54): load_path_requests(), call(), GlorboWeb.InboxLive, approval_key(), audit_key(), decode_audit(), handle_event(), handle_info() (+46 more)
...
Cohesion: 0.06
Nodes (42): Glorbo.CLI, dispatch(), ensure_repo_started(), help_text(), render_fmt_output(), render_init_summary(), run_checks(), Glorbo.Init.ExampleCompany (+34 more)
...
Cohesion: 0.08
Nodes (41): Glorbo.CLI.Harness.HTTP, attempt_request(), base_retry_delay_ms(), blank_to_nil(), configure_proxy(), do_request(), ensure_started(), http_options() (+33 more)
...
Cohesion: 0.1
Nodes (40): Glorbo.CLI.Harness, auth_headers(), auth_headers_for(), blank_to_nil(), build_runtime_config(), build_usage(), chat_completion(), chat_url() (+32 more)
...
Cohesion: 0.11
Nodes (17): Glorbo.Doctor, check_audit_dir(), check_disk_space(), check_erts_version(), check_glorbo_dir(), check_linux_kernel(), check_private_files(), check_sockets_dir() (+9 more)
...
Cohesion: 0.14
Nodes (20): GlorboWeb.OverviewLive, agent_count(), agent_spend_usd(), alert_count(), company_goals(), company_name(), count_in_progress_in_project(), do_load_company() (+12 more)
...
- **Thin community `Community 28`** (34 nodes): `parser.ex`, `Glorbo.Agent.Parser`, `default_egress()`, `derive_company()`, `derive_slug()`, `parse_budget_monthly_usd()`, `parse_egress_mode()`, `parse_host_list()`, `parse_icon()`, `parse_legacy_budget_cents()`, `parse_reports_to()`, `parse_smart_model()`, `parse_untracked()`, `read_file()`, `reject_agents_create()`, `validate_autonomy()`, `validate_budget()`, `validate_egress()`, `validate_heartbeat()`, `validate_http_max_retries()`, `validate_http_timeout()`, `validate_max_retries()`, `validate_max_tool_calls_per_turn()`, `validate_model()`, `validate_models_aliases()`, `validate_network()`, `validate_one_permission()`, `validate_one_skill()`, `validate_permissions()`, `validate_provider()`, `validate_skills()`, `validate_slug()`, `validate_timeout()`, `validate_web_fetch_timeout()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (7 nodes): `provider.ex`, `Glorbo.CLI.Registry.Provider`, `auth_modes()`, `kinds()`, `model_list_shapes()`, `prompt_modes()`, `status()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (7 nodes): `GlorboWeb.Components.CompanyCard`, `agent_label()`, `alert_label()`, `company_card()`, `goal_label()`, `progress_state()`, `company_card.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (6 nodes): `heartbeat_md.ex`, `Glorbo.FileSpec.HeartbeatMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (6 nodes): `soul_md.ex`, `Glorbo.FileSpec.SoulMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (6 nodes): `memory_index_md.ex`, `Glorbo.FileSpec.MemoryIndexMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (6 nodes): `sentinel_approval_md.ex`, `Glorbo.FileSpec.SentinelApprovalMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (6 nodes): `sentinel_stuck_md.ex`, `Glorbo.FileSpec.SentinelStuckMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (6 nodes): `sentinel_resolution_md.ex`, `Glorbo.FileSpec.SentinelResolutionMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (6 nodes): `Glorbo.FileSpec.BraindumpMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`, `braindump_md.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (6 nodes): `Glorbo.FileSpec.ChannelLogMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`, `channel_log_md.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (6 nodes): `inbox_archive_json.ex`, `Glorbo.FileSpec.InboxArchiveJson`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (6 nodes): `Glorbo.FileSpec.AuditMonthJsonl`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`, `audit_month_jsonl.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (6 nodes): `memory_entry_md.ex`, `Glorbo.FileSpec.MemoryEntryMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 57`** (6 nodes): `skill_md.ex`, `Glorbo.FileSpec.SkillMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (6 nodes): `Glorbo.FileSpec.EmergencyStopMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`, `emergency_stop_md.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (6 nodes): `inbox_message_md.ex`, `Glorbo.FileSpec.InboxMessageMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (6 nodes): `goal_md.ex`, `Glorbo.FileSpec.GoalMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (6 nodes): `Glorbo.FileSpec.ConfigMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`, `config_md.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (6 nodes): `task_md.ex`, `Glorbo.FileSpec.TaskMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (6 nodes): `project_md.ex`, `Glorbo.FileSpec.ProjectMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (6 nodes): `Glorbo.FileSpec.CompanyMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`, `company_md.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (6 nodes): `path_request_md.ex`, `Glorbo.FileSpec.PathRequestMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (6 nodes): `proposal_md.ex`, `Glorbo.FileSpec.ProposalMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (6 nodes): `task_comments_md.ex`, `Glorbo.FileSpec.TaskCommentsMd`, `canonical_key_order()`, `docs()`, `frontmatter_schema()`, `kind()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (5 nodes): `Glorbo.Agent.FileLayout`, `agent_md_candidates()`, `agent_md_canonical()`, `heartbeat_md()`, `file_layout.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (5 nodes): `icon.ex`, `GlorboWeb.Components.Icon`, `glyph()`, `icon()`, `missing?()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (5 nodes): `stdout_tail.ex`, `GlorboWeb.Components.StdoutTail`, `exit_code_class()`, `stdout_line()`, `stdout_tail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (5 nodes): `GlorboWeb.Components.ChatDrawer`, `chat_drawer()`, `director?()`, `short_ts()`, `chat_drawer.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (4 nodes): `Glorbo.CLI.DoctorFix`, `help_text()`, `run()`, `doctor_fix.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (4 nodes): `Glorbo.CLI.Parsers.GeminiStdout`, `parse()`, `reduce_models()`, `gemini_stdout.ex`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `default_root()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 18`, `Community 19`, `Community 21`, `Community 22`, `Community 23`, `Community 26`, `Community 29`, `Community 30`, `Community 32`, `Community 34`, `Community 36`, `Community 41`, `Community 42`?**
  _High betweenness centrality (0.160) - this node is a cross-community bridge._
- **Why does `parse()` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 24`, `Community 25`, `Community 26`, `Community 29`, `Community 32`, `Community 33`, `Community 34`, `Community 35`, `Community 37`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `read()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 18`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 27`, `Community 28`, `Community 30`, `Community 32`, `Community 33`, `Community 35`, `Community 36`, `Community 37`, `Community 42`?**
