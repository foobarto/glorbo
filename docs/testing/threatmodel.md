...
Codex scan (2026-04-22 / 2026-04-23 sweep, 126 findings). **69 open** ·
...
0600 flow); post-wave-7 follow-up fixes on 2026-04-23 closed 5 more
...
metadata-only refresh); wave 5 also discovered 6 more mediums were
already fixed by earlier waves
(false-positive Codex flags; verified against HEAD).

Breakdown: 0 critical, 0 high, 6 medium, 39 low, 24 informational.
...
### Medium (constrained exploit — local access or misconfig) — 6
