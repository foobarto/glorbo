...
- Open findings in `docs/testing/threatmodel.md`: `71`
- Breakdown: `0` critical, `0` high, `8` medium, `39` low,
  `24` informational
...
- Planned scope: drive the open medium count below `8` while the new
