...
- Open findings in `docs/testing/threatmodel.md`: `72`
- Breakdown: `0` critical, `0` high, `9` medium, `39` low,
  `24` informational
...
- Planned scope: drive the open medium count below `9` while the new
