...
| 0060 | [SymlinkGuard must resolve the glorbo home, not trip on system symlinks above it (atomic-distro `/home → /var/home`)](./0060-symlinkguard-resolve-home-above-workspace.md) | Standards | Implemented |
