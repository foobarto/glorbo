...
> file specs, GEP-26 benchmarks, GEP-27 path requests, **GEP-28 agent
> proposals**, **heartbeat empty-inbox fix**, **system prompt enrichment**)
> or been superseded by newer GEPs. Kept for historical reference;
> active planning lives in `docs/geps/` and `CHANGELOG.md`.
