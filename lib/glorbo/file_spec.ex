defmodule Glorbo.FileSpec do
  ...
  Status: **shipped** (GEP-25). The validator (`Glorbo.FileSpec.Validator`,
  `glorbo validate`), formatter (`Glorbo.FileSpec.Formatter`, `glorbo fmt`),
  and the autogenerated `docs/file-formats/` (`mix glorbo.docs.file_formats`)
  all read this registry; `kind:`↔path mismatch is a validator error (D8).
  """
