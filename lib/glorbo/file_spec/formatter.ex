defmodule Glorbo.FileSpec.Formatter do
  ...
  Distinct from the eventual file-rewriter (R26.2b). This module
  only formats the validator's findings list for the CLI: human
  text, NDJSON (one finding per line, GEP-25 D6), or a one-line
  summary count.
  """
