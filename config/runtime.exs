...
if config_env() == :dev do
  # A one-shot child prints the first-run URL only when Phoenix is actually
  # serving. Keeping this flag non-secret lets runtime config remain safe to
  # evaluate during compile, audit, migration, and other Mix tasks.
  config :glorbo, :dev_setup_banner, true
